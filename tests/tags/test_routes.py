...
class TestCreate:
    ...
    @mark.parametrize(
        "body",
        indirect=True,
        argvalues=[{"name": "tag4", "description": "desc_1"}, {"name": "tag4"}],
    )
    ...
    @mark.parametrize("token_iss", [users[0]["iss"]], indirect=True)
    @mark.parametrize(
        "body", indirect=True, argvalues=[{"name": "tag4", "description": "desc_1"}]
    )
    ...
    @mark.parametrize(
        "body",
        indirect=True,
        argvalues=[{"name": "tag1", "description": "desc_1"}, {"name": "tag1"}],
    )
    ...
    @mark.parametrize(
        "body",
        indirect=True,
        argvalues=[{"description": "desc_1"}, {}],  # Missing name  # Empty body
    )
...
@mark.parametrize(
    "tag_id",
    indirect=True,
    argvalues=[tags[0]["id"], tags[1]["id"], tags[2]["id"], tags[3]["id"]],
)
class TestGet:
...
class TestUpdate:
    ...
    @mark.parametrize("body", indirect=True, argvalues=[{"description": "new_desc"}])
